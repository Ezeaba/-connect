            ...
            <div class="jumbotron jumbotron-fluid">
                    <div class="container">
                      <h1 class="display-4">About Us</h1>
                        <p>Rea-Connekt is connecting investors with startups and investment ready companies. 
                        <p>ReaTech connect is run by Reatech Coperations, in close partnership with DvCorp. 
                        <p>Through our activities and other programs we are in a unique position which give us insight to hundreds of startups and investment ready companies yearly. This, together with our active sourcing, gives our investors the possibility to pick first hand.</p>
                    
                        <h3>Our Vision</h3>
                        <p>We at Rea-Connekt are working towards reducing the rate of unemployment and underemployment in Nigeria.

                        <h3>Our Mission</h3>
                        <p>We intend to achieve our vision by exposing Inventors, Innovators and Artisans to Investors.
